...
#   puts counter
#   break if counter > 20
# end # test to show that the counter inside the loop "do end" is read by the outer loop, too (need to refresh variable scoping for loops)

# def snake(str)
#   words = str.split
#   current_word = 1 # here is the error, should index starting at 0
